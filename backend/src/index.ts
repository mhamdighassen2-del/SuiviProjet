...
import repereRouter from './controllers/repere.controller';
import referentielRouter from './controllers/referentiel.controller';
...
app.use('/api', repereRouter);
app.use('/api', referentielRouter);
